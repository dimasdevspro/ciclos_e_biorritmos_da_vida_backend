...
app.get("/ceu", async (req, res) => {
    try {
        ...
        const constelacoesPT = {
            ...
            Cancer: "Câncer",
            CanesVenatici: "Cães de Caça",
            CanisMajor: "Cão Maior",
            CanisMinor: "Cão Menor",
            ...
            Circinus: "Compasso",
            Columba: "Pomba",
            ComaBerenices: "Cabeleira de Berenice",
            CoronaAustralis: "Coroa Austral",
            CoronaBorealis: "Coroa Boreal",
            Corvus: "Corvo",
            Crater: "Taça",
            ...
            Tucana: "Tucano",
            UrsaMajor: "Ursa Maior",
            UrsaMinor: "Ursa Menor",
            Vela: "Velas",
            Virgo: "Virgem",
            Volans: "Peixe Voador",
            Vulpecula: "Raposa",
        ...
        const traducao =
            constelacoesPT[constellation.name];

        const nomeConstelacao = traducao
            ? `${constellation.name} (${traducao})`
            : constellation.name;
        ...
        res.json({
            ...
            constelacaoDominante: nomeConstelacao,
